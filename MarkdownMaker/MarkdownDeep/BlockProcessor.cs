...
namespace MarkdownMaker.MarkdownDeep
{
    ...
    /// Implements the <see cref="MarkdownDeep.StringScanner" />
    /// </summary>
    ...
    public class BlockProcessor : StringScanner
	{
        ...
        /// <param name="MarkdownInHtml">if set to <c>true</c> [markdown in HTML].</param>
        ...
        /// <summary>
        /// Gets the markdown mode.
        /// </summary>
        /// <param name="tag">The tag.</param>
        /// <returns>MarkdownInHtmlMode.</returns>
        ...
        /// <summary>
        /// Processes the markdown enabled HTML.
        /// </summary>
        /// <param name="b">The b.</param>
        ...
        /// <summary>
        /// Processes the fenced code block.
        /// </summary>
        /// <param name="b">The b.</param>
        /// <returns><c>true</c> if XXXX, <c>false</c> otherwise.</returns>
